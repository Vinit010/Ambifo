...
export const sentinelData: PlatformData = {
  heroTag: 'Intelligence First · Outcome-Driven',
  heroTitle: 'The AI-first platform for operations that sense, predict and act.',
  heroSubtitle: 'SENTINEL is Ambifo\'s AI-native Autonomous & Intelligent IT-OT Operations Platform — unifying the physical world of plants, grids, towers and distributed machines with the digital world of enterprise systems. Powered by AI and agentic automation, it goes beyond dashboards: it predicts, recommends and — with your teams in control — automates routine actions, helping optimise operations at scale.',
  heroDescription: 'SENTINEL is AI-native to its core. It unifies the operational technology layer with the IT layer into a single, cloud-native control plane.',
  ctaText: 'Book Now!',
  platformTitle: 'SENTINEL — Autonomous & Intelligent IT-OT Operations Platform',
  platformDescription: 'SENTINEL is AI-native to its core. It unifies the operational technology layer — sensors, PLCs, SCADA, RTUs, meters, energy and process assets — with the IT layer — work orders, ERP, maintenance systems, field workforce and analytics — into a single, cloud-native control plane. Where most tools stop at dashboards and recommendations, SENTINEL adds an agentic layer that can execute and verify routine actions under human oversight — helping distributed assets and facilities run as a more proactive, intelligent operation.',
  platformFeatures: [
    ...
    { icon: Users, title: 'Platform + Partner', description: 'SENTINEL ships with Ambifo\'s engineering, integration and managed-operations expertise — an outcome delivered and operated, not a licence handed over.' },
  ],
  ...
  solutionsTitle: 'How SENTINEL solves them',
  solutions: [
  ...
  reframeText: 'The reframe for industrial leaders: the question is no longer "can we see and predict?" It is "can our operation get smarter and more autonomous — securely, in real time, across IT and OT together?" As competing tools race to call themselves AI platforms, SENTINEL is AI-native by design: it can act on insight with your teams in control, not just advise.',
  ...
  outcomesTitle: 'Outcomes SENTINEL delivers',
  outcomes: [
  ...
  ctaDescription: 'Book a no-risk discovery workshop — we\'ll map your IT-OT maturity and demonstrate SENTINEL on live data within 6–8 weeks.',
}

export const prismData: PlatformData = {
  heroTag: 'Real-Time Intelligence · Outcome-Led',
  heroTitle: 'Agentic AI-powered intelligence for every frame, track and broadcast.',
  heroSubtitle: 'PRISM is Ambifo\'s Agentic AI-powered Media Intelligence Platform — purpose-built for broadcasters, OTT platforms, sports rights holders, music labels and content owners. It turns raw media — video, audio, ad logs, music catalogues and schedules — into decision-ready intelligence, automatically, around the clock — with autonomous AI agents that don\'t just surface insight, they act on it.',
  heroDescription: 'PRISM unifies every content type — broadcast, OTT, advertising, news and music — into a single video-intelligence and content-understanding layer.',
  ctaText: 'Book Now!',
  platformTitle: 'PRISM — Media Intelligence Platform',
  platformDescription: 'AI runs through every layer of PRISM. It unifies every content type — broadcast, OTT, advertising, news and music — into a single video-intelligence and content-understanding layer, with multi-modal, agentic AI that ingests, tags, analyses, proves — and acts. Cloud-native and deployed in your VPC or fully managed, PRISM moves media operations from manual logging and fragmented tools to a workforce of AI agents that run content operations at scale.',
  platformFeatures: [
    ...
    { icon: Users, title: 'Delivered and Run by Ambifo', description: 'PRISM ships with Ambifo\'s media-native engineering and managed-operations expertise — a working outcome we deliver and run, not a licence dropped in your lap.' },
  ],
  ...
  solutionsTitle: 'How PRISM closes the gap',
  solutions: [
  ...
  reframeText: 'The shift for media leaders: the question is no longer "can we store and stream it?" It is "can every asset instantly tell us what\'s inside, prove it, and help us monetise it?" PRISM is agentic by design — its AI agents analyse, prove and act, not just store.',
  ...
  outcomesTitle: 'Outcomes PRISM delivers',
  outcomes: [
  ...
  engagementStages: [
    ...
    { icon: Cpu, title: 'Production', description: 'Full ingestion, QC workflow, security hardening and APIs — PRISM live in your environment.' },
  ...
  ctaHeading: 'See PRISM on your own content.',
  ctaDescription: 'Book a discovery session and we\'ll map your media assets, identify your highest-ROI use case, and demonstrate exactly what PRISM can deliver — in 2–3 weeks.',
}

export const forgeData: PlatformData = {
  heroTag: 'Spec-Driven · Governed by Design',
  heroTitle: 'Take software from idea to production the agentic AI way.',
  heroSubtitle: 'FORGE is Ambifo\'s agentic AI software delivery platform. One command per stage carries a project from spec to architecture to UX to backlog to built, tested features — AI agents do the heavy lifting while your team decides, reviews and signs off at every gate. Engineering standards, tests and security are loaded in, not bolted on.',
  heroDescription: 'FORGE turns AI from a scattered coding assistant into a governed, end-to-end delivery engine.',
  ctaText: 'Book Now!',
  platformTitle: 'FORGE — one platform, one command per stage',
  platformDescription: 'FORGE turns AI from a scattered coding assistant into a governed, end-to-end delivery engine. An engineer or delivery lead runs a single command at each stage; agents write the specs, design the UX, generate the architecture, produce the backlog and build the features — with people firmly in control at every gate. It\'s spec-driven engineering, not vibe-coding.',
  platformFeatures: [
  ...
  solutionsTitle: 'With FORGE — a system',
  solutions: [
  ...
  reframeText: 'The move for engineering leaders: the win isn\'t another AI assistant — it\'s making AI delivery a system. FORGE turns scattered, individual AI use into one governed flow, so speed and quality stop being a trade-off.',
  ...
  outcomesTitle: 'Outcomes FORGE delivers',
  outcomes: [
  ...
  ctaHeading: 'Put FORGE on your next build.',
