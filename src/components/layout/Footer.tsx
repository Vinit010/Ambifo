...
const SocialIcon = ({ icon }: { icon: string }) => {
  switch (icon) {
    ...
    case 'youtube':
      return <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
    case 'instagram':
...
function FooterNavLink({ to, label }: { to: string; label: string }) {
  if (to.startsWith('http')) {
    return (
      <a href={to} target="_blank" rel="noopener noreferrer" className="block text-gray-400 hover:text-yellow-400 text-sm transition-colors py-0.5">
        {label}
      </a>
    )
  }
  return (
    <Link to={to} className="block text-gray-400 hover:text-yellow-400 text-sm transition-colors py-0.5">
      {label}
    </Link>
  )
}
  ...
  return (
    <footer className="bg-navy-900 text-gray-300">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-9 gap-8 lg:gap-6">
          {footerServices.map((group) => (
            <div key={group.heading}>
              <Link
                to={group.links[0]?.link || '#'}
                className="block text-white font-semibold text-sm mb-3 hover:text-yellow-400 transition-colors uppercase tracking-wider"
              >
                {group.heading}
              </Link>
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3 uppercase tracking-wider">Platforms</h3>
            <ul className="space-y-1">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3 uppercase tracking-wider">Solutions</h3>
            <ul className="space-y-1">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3 uppercase tracking-wider">Offices</h3>
            <ul className="space-y-1">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3 uppercase tracking-wider">Industries</h3>
            <ul className="space-y-1">
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-3 uppercase tracking-wider">Insights & Resources</h3>
            <ul className="space-y-1">
        ...
        <div className="mt-12 pt-8 border-t border-navy-700 flex flex-col md:flex-row items-center justify-between gap-6">
          <Link
            to="/contact-us"
            className="inline-flex items-center px-6 py-3 bg-yellow-400 text-navy-900 font-semibold text-sm rounded-lg hover:bg-yellow-500 transition-colors"
          >
            Contact Us
          </Link>
        ...
        <div className="mt-8 pt-6 border-t border-navy-700 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
